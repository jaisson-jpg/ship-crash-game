// auth-simple.js - Versão que usa apenas Firebase
...
window.fazerLogin = async function() {
  ...
  try {
    ...
    console.log('4. Salvando dados via AuthManager...');
    authManager.saveAuthData(token, userId, fullName, balance, role);
    console.log('✅ Dados salvos');
    
    console.log('5. Login bem-sucedido, redirecionando...');
    if (authMessage) {
...
window.fazerRegistro = async function() {
  ...
  try {
    ...
    console.log('6. Salvando dados via AuthManager...');
    authManager.saveAuthData(loginToken, nextUserId, name, initialBalance, 'player');
...
console.log('auth-simple.js: Funções globais criadas'); 